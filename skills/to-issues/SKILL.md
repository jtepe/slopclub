...
For each approved slice, save a new issue to a file under `./issues`. Use the issue body template below. These issues are considered ready for AFK agents, so save them with the correct triage label unless instructed otherwise.
