...
2. Ticket references in the commit messages (`#123`, `Closes #45`, etc.) — resolve them to the matching ticket file under `./tickets` (files start with the ticket number).
3. A spec/PRD file under `./spec`, or `docs/`, `specs/`, or `.scratch/` matching the branch name or feature.
